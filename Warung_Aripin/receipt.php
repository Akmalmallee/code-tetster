...
?><!doctype html>
<html>
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Receipt #<?= $id ?></title>
      ...
      <div class="card">
        ...
        <table style="width:100%;border-collapse:collapse">
          <?php foreach($order['items'] as $s): ?>
            <tr><td><?= htmlspecialchars($s['name']) ?> x<?= intval($s['qty']) ?></td><td align="right">Rp <?= number_format($s['subtotal'],0,',','.') ?></td></tr>
          <?php endforeach; ?>
          <tr><td><strong>Total</strong></td><td align="right"><strong>Rp <?= number_format($order['total'],0,',','.') ?></strong></td></tr>
        </table>
