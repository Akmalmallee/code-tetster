...
<!doctype html>
<html lang="id">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Orders - Admin</title>
    ...
    <?php else: ?>
      <div class="card">
        <table style="width:100%;border-collapse:collapse">
          <thead><tr><th>ID</th><th>Nama</th><th>Total</th><th>Tanggal</th><th>Status</th><th></th></tr></thead>
          <tbody>
