...
if(!empty($errors)){
  ...
  <!doctype html>
  <html lang="id">
  <head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Kesalahan - Warung Aripin</title>
...
try{
  foreach($snapshot as $s){
    ...
    if($currentStock < $s['qty']){ $ok = false; break; }
    // decrement
  ...
  if(!$ok){
    ...
    <!doctype html>
    <html lang="id">
    <head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Stok Tidak Cukup</title>
    <link rel="stylesheet" href="assets/css/style.css" /></head>
    <body>
      <div class="container">
        <div class="card" style="border-left:4px solid #f43f5e;">
  ...
  ?>
  <!doctype html>
  <html lang="id"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Error</title>
  <link rel="stylesheet" href="assets/css/style.css" /></head>
  <body><div class="container"><div class="card" style="border-left:4px solid #f43f5e;"><h3>Terjadi kesalahan</h3><p><?= htmlspecialchars($e->getMessage()) ?></p><a href="shop.php" class="btn">Kembali</a></div></div></body></html>
  <?php
  exit;
}
...
// get payment name
$pmName = $payment;
try{ $s = $db->prepare('SELECT method FROM payment_methods WHERE id = :id'); $s->execute([':id'=>$payment]); $r = $s->fetch(PDO::FETCH_ASSOC); if($r) $pmName = $r['method']; } catch(Exception $e){}
?>
<!doctype html>
<html lang="id">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Terima Kasih - Warung Aripin</title>
<link rel="stylesheet" href="assets/css/style.css" /></head>
<body>
  <div class="container">
      ...
      <div>
        <?php if(!empty($snapshot)): ?>
          <table style="width:100%;border-collapse:collapse">
            <thead><tr><th align="left">Barang</th><th align="right">Harga</th><th align="center">Qty</th><th align="right">Subtotal</th></tr></thead>
            <tbody>
