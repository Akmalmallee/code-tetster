...
<body>
  <div class="container">
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:18px">
      ...
      <div><h1>Warung Aripin</h1><div class="small">Kelontong & kebutuhan sehari-hari</div></div>
      <div class="cart-icon" onclick="window.scrollTo({top:document.body.scrollHeight,behavior:'smooth'})">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 6h15l-1.5 9h-12z" stroke="#0f172a" stroke-width="1.2" stroke-linejoin="round" stroke-linecap="round"/></svg>
  ...
  <script>window.WA_ITEMS = <?= json_encode($items) ?>;</script>
