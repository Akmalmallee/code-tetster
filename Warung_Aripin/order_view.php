...
if($id && file_exists($dbFile)){
  ...
  if($order){
    ...
    $pm = $db->prepare('SELECT method FROM payment_methods WHERE id = :id'); $pm->execute([':id'=>$order['payment_method']]); $r = $pm->fetch(PDO::FETCH_ASSOC); if($r) $order['payment_method_name'] = $r['method']; else $order['payment_method_name'] = $order['payment_method'];
  }
}
?>
<!doctype html>
<html lang="id">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Order #<?= $id ?></title>
    ...
    <?php else: ?>
      <div class="card">
        ...
        <table style="width:100%;border-collapse:collapse">
          <thead><tr><th>Barang</th><th align="right">Harga</th><th align="center">Qty</th><th align="right">Subtotal</th></tr></thead>
          <tbody>
